	...
	return (
		<div className="Home">
			...
			<div className="container">
				...
				<div className="content" data-testid="home-content">
					<div className="header">
						...
						<div className="buttons">
							...
							<button data-testid="theme-button" className="btn-circle margin" title="Mudar Tema" onClick={ changeTheme }>
							...
							<button data-testid="delete-account-button" className="btn-circle danger margin" title="Excluir Conta" onClick={ () => setShowDeletAccountModal(true) }>
